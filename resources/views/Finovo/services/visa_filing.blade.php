...
@section('content')
  ...
  <header class="counselling-banner">
    <div class='overlay'></div>
        <div class="container">
            <h1>Visa Filling</h1> <!-- Update for each page -->
    ...
    <section class="info-section">
        <div class="container">
            ...
            <div class="row ">
                <div class="col-md-7">
                <h2 class="section-title">Why Choose Our Visa Filling?</h2> <!-- Update for each page -->
...
@endsection
    ...
    background-image: url('https://thumbs.dreamstime.com/b/visa-22456825.jpg');
