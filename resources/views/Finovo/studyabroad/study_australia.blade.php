...
@section('content')
  ...
  <header class="us-banner">
    ...
    <!-- Why Study in the Australia Section -->
    <section class="section">
        <div class="container">
            <h2>Why Study in the Australia?</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="icon-box">
...
@endsection
    ...
    background-image: url('https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YXVzdHJhbGlhfGVufDB8fDB8fHww');
