...
@section('content')
  ...
  <header class="us-banner">
    <div class='overlay'></div>
        <div class="container">
            <h1>Study in the New Zealand</h1>
    ...
    <!-- Why Study in the New Zealand Section -->
    <section class="section">
        <div class="container">
            <h2>Why Study in the New Zealand?</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="icon-box">
...
@endsection
    ...
    background-image: url('https://media.istockphoto.com/id/691610536/photo/aucklands-skyline-at-dawn.jpg?s=612x612&w=0&k=20&c=DzVz5VEhegR357pduaFTKd1I5ofjdrAS6kQRl1cuNdg=');
