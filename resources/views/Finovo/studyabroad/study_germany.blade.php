...
@section('content')
  ...
  <header class="us-banner">
    ...
    <!-- Why Study in the Germany Section -->
    <section class="section">
        <div class="container">
            <h2>Why Study in the Germany?</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="icon-box">
...
@endsection
    ...
    background-image: url('https://t3.ftcdn.net/jpg/02/21/18/08/360_F_221180840_Y5kUey7DViNTInZ25FmYrX7JRJlvdmm2.jpg');
