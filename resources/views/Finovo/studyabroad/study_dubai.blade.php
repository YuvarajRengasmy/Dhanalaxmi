...
@section('content')
  ...
  <header class="us-banner">
    ...
    <!-- Why Study in the Dubai Section -->
    <section class="section">
        <div class="container">
            <h2>Why Study in the Dubai?</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="icon-box">
...
@endsection
    ...
    background-image: url('https://thumbs.dreamstime.com/b/dubai-marina-beauty-view-rooftop-showing-cityscape-boats-sea-view-51444879.jpg');
