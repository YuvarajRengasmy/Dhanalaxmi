                ...
                <tbody>
                    @forelse ($agents as $index => $agent)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('universities.destroy', $agent->id) }}" method="POST">
                                    <a class="btn btn-info btn-sm" href="{{ route('agents.show', $agent->id) }}">
                                        <i class="fa fa-eye"></i> 
                                    </a>
                                    <a class="btn btn-primary btn-sm" href="{{ route('agents.edit', $agent->id) }}">
                                        <i class="fa fa-pen"></i> 
                                    </a>
                                    @csrf
                                    @method('DELETE')
