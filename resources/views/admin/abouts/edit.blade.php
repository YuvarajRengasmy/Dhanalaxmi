...
<div class="card mt-5">
    <div class="card-body">
        <h4 class="card-header">Edit Abouts</h4>
            ...
            <div class="row col-12 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input 
                        ...
                        value="{{ old('title_one', $about->title_one) }}">
                    @error('title_one')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea 
                        ...
                        rows="4">{{ old('description_one', $about->description_one) }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input 
                        ...
                        id="title_two" 
                        placeholder="Enter The Title" 
                        value="{{ old('title_two', $about->title_two) }}">
                    @error('title_two')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea 
                        ...
                        id="description_two" 
                        placeholder="Start writing your content here..." 
                        rows="4">{{ old('description_two', $about->description_two) }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input 
                        ...
                        id="title_three" 
                        placeholder="Enter The Title" 
                        value="{{ old('title_three', $about->title_three) }}">
                    @error('title_three')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <textarea 
                        ...
                        placeholder="Start writing your content here..." 
                        rows="4">{{ old('description_three', $about->description_three) }}</textarea>
