                            ...
                            <tbody>
                                @foreach ($typeContacts as $typeContact)
                                    <tr>
                                        ...
                                        <td>
                    <a href="{{ route('admin.enquiry.edit', [$typeContact->id, 'enquiry']) }}" class="btn btn-warning btn-sm">Edit</a>
                            ...
                            <tbody>
                                @foreach ($generalContacts as $generalContact)
                                    <tr>
                                        ...
                                        <td>
                    <a href="{{ route('admin.enquiry.edit', [$generalContact->id, 'inquiry']) }}" class="btn btn-warning btn-sm">Edit</a>
