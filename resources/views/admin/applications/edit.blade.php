...
<div class="card mt-5">
  ...
  <h4 class="card-header">Edit Applications</h4>
...
<div class="row col-12 mb-3">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input 
                ...
                name="preferedStudyDestination" 
                 value="{{ $application->preferedStudyDestination }}"
        ...
        <div class="col-md-6 mb-3">
            ...
            <input 
                type="text" 
                name="courseInterest" 
                value="{{ $application->courseInterest }}"
        ...
        <div class="col-md-6 mb-3">
            ...
            <input 
                type="text" 
                name="preferedIntake" 
                value="{{ $application->preferedIntake }}"
        ...
        <div class="col-md-6 mb-3">
            ...
            <input 
                type="text" 
                name="preferedYear" 
                value="{{ $application->preferedYear }}"
