        ...
        <form action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row col-12 mb-3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="file" name="event_type" class="form-control @error('event_type') is-invalid @enderror" id="event_type">
                    @error('event_type')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
           ...
           <input type="file"  name="location" class="form-control mb-2 @error('location') is-invalid @enderror" id="customFile" />      
                    @error('location')
                        <div class="form-text text-danger">{{ $message }}</div>
                    @enderror
                </div>
