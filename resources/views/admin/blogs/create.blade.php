...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <label class="form-label" for="customFile"><strong>Image Three:</strong></label>
           <input type="file"  name="image_three" class="form-control mb-2 @error('image_three') is-invalid @enderror" id="customFile" />
